package com.stone.ripple.crawler.image;

import java.io.File;
import java.util.UUID;
import com.google.common.io.Files;
import com.stone.ripple.crawler.common.AbstractCrawlerClass;
...
public class ImageCrawler extends AbstractCrawlerClass {
	...
	public void visit(Page page) {
		...
		if (!imgPattern.matcher(url).matches() || !((page.getParseData() instanceof BinaryParseData)
